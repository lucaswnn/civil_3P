...
class ExampleShellDesignPlugin(TaskPlugin):
    ...
    def execute(
        ...
        my_df = my_df[my_df[rpr.Origin2DResultsColumns.CASE] == case]
        result_df[task_rpr_2d.ELEMENT] = my_df[rpr.Origin2DResultsColumns.ELEMENT]
        result_df[task_rpr_2d.NODE] = my_df[rpr.Origin2DResultsColumns.NODE]
        result_df[task_rpr_2d.VALUE] = my_df[rpr.Origin2DResultsColumns.BENDING_22]
